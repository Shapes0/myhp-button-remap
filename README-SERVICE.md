# HP Button Remap - Windows Service Edition

Native Windows Service with GUI Configurator for remapping HP laptop special function keys.

## Overview

This is a **Windows Service** with a **GUI configurator** that monitors HP WMI events and allows you to configure custom actions when special HP laptop buttons are pressed. It runs as a background service with an easy-to-use configuration interface.
...
3. **Right-click** `Install-Service.ps1` and select **"Run with PowerShell"**
